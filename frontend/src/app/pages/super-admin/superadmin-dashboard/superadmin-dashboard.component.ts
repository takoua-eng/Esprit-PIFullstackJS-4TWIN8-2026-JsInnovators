...
@Component({
  selector: 'app-superadmin-dashboard', // ✅ modifié
  standalone: true,
  imports: [
    CommonModule,
    MaterialModule,
  ...
  templateUrl: './superadmin-dashboard.component.html', // ✅ modifié
})
export class SuperAdminDashboardComponent {
  ...
  users: UserRow[] = [
    ...
    {
      name: 'Admin Chirurgie',
      email: 'admin.chirurgie@hospital.tn',
      role: 'Admin',
      service: 'Surgery',
      status: 'Active',
    },
    {
      name: 'John Patient',
      email: 'john.patient@hospital.tn',
      role: 'Patient',
      service: 'Cardiology',
      status: 'Active',
    },
    {
      name: 'Sarah Patient',
      email: 'sarah.patient@hospital.tn',
      role: 'Patient',
      service: 'Oncology',
      status: 'Inactive',
    },
    ...
    {
      name: 'Nurse Amira',
      email: 'amira.nurse@hospital.tn',
      role: 'Nurse',
      service: 'Oncology',
      status: 'Active',
    },
    {
      name: 'Coordinator Anis',
      email: 'anis.coordinator@hospital.tn',
      role: 'Coordinator',
      service: 'Cardiology',
      status: 'Inactive',
    },
